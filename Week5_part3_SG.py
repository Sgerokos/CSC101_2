...
# Reterns the output for the input in spectral        
def getSpectral(spectral):
...
def main():
    ...
    # Call's getSpectral(spectral) if the input is between 380 - 700
    while spectral >= 380 and spectral <= 700:
        # Call's the function getSpectral(spectral)
